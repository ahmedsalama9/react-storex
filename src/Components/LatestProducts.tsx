          ...
          <Swiper
           ...
           {products.map((item, i) => (
            ...
            <div className="flex flex-col items-start p-4 shadow-lg  rounded-lg ">
              ...
              {/* <div className="flex flex-row w-[90%] mx-auto gap-5">
           <button className="flex flex-row gap-2 bg-[var(--theme-dark)] text-white px-2 py-1 rounded-lg cursor-pointer hover:scale-104 transition-all duration-400">
             <img src={Cart} alt="cart" className="w-5" /> View
           </button>
           <button className="flex flex-row gap-2 bg-[var(--theme-dark)] text-white px-2 py-1 rounded-lg  cursor-pointer hover:scale-104 transition-all duration-400">
             <img src={Wish} alt="cart" className="w-5" /> Compare
           </button>
         </div> */}
              <span></span>
